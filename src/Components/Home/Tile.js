...
{/* //           <div className='profile-div'><img className='profile-image' src={data.profile_Image} alt='gr' /></div> */}
    ...
    <div className='follow-button flex text-sm'><p className='self-center'>+ Follow</p></div>
     ...
     <div className='w-full first'>
      <h3 className='font-black text-3xl'>{data.name}</h3>
      <p className='text-md pt-2 first-p'>{data.desc}</p>
>>>>>>> 77776a5bf55132593ee7ccd9ad0f5b08712b4fa4
     </div>
...
<div className='px-4 py-1'>
 <p className='font-bold  text-lg md:text-2xl okay-bold'>{data.minInvestment}</p>
 <p>Min Invest</p>
 </div>
 <div style={{borderLeft:'1px solid #000',height:'40px'}} className='grid self-center mr-1'></div>

 <div className='px-4 py-1'>
 <p className='font-bold text-lg md:text-2xl okay-bold'>{data.targetAmount}</p>
 <p>Target</p>
 </div>
>>>>>>> 77776a5bf55132593ee7ccd9ad0f5b08712b4fa4
<div style={{borderLeft:'1px solid #000',height:'40px'}} className='grid self-center mr-1'></div>
...
=======
   <div>{data.amountInvested} Raised</div>
   <div> 7 days left</div>
 </div>
>>>>>>> 77776a5bf55132593ee7ccd9ad0f5b08712b4fa4
</div>
